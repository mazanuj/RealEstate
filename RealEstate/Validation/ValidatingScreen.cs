...
namespace RealEstate.Validation
{
    ...
    public abstract class ValidatingScreen<TViewModel> : ScreenWithToogleTools, IDataErrorInfo where TViewModel : ValidatingScreen<TViewModel>
	{
		...
		/// <param name="errors">The list of errrors generated by validators</param>
		protected virtual void OnColumnError(string columnName, Dictionary<Type, string> errors)
		{
			// Does nothing
		}
		...
		public string this[string columnName]
		{
			get
			{
			    if (!propertyGetters.ContainsKey(columnName)) return string.Empty;
			    ...
			    // Realize a list and send to the OnColumnError() method
			    OnColumnError(columnName, errors);

			    return string.Join(Environment.NewLine, errors.Values.ToArray());
			}
		}

		private static bool IsEnabled(INotifyPropertyChanged instance, ValidationAttribute validator, string propertyName)
		{
